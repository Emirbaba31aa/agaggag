...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        client.channels.cache.get(config.logs.isimlog).send({ embeds: [embed.setDescription(`${member} kullanıcısının ismi ${message.author} tarafından \`${name} | ${age}\` olarak değiştirildi.
